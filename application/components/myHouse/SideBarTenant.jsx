        ...
        return (
          <Link href={link.link}>
            <div
              ...
              className={`flex px-3 rounded-lg py-2 gap-5 ${
                link.label === active && "bg-[#2A3E5A]"
              } justify-start items-center hover:bg-[#2A3E5A] cursor-pointer transition-all duration-300 text-[#B0C5E7] hover:text-white`}
            >
