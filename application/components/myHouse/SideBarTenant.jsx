      ...
      <div className="flex flex-col h-screen py-3 pl-3 pr-0 bg-white  shadow w-60">
        <div className="space-y-3">
          ...
          <div className="flex-1">
            ...
            <li className={`rounded-sm hover:bg-black hover:text-white ${"My House"===active&&'bg-black text-white'}`} onClick={()=>handleNavigate("My House")}>
                <Link
                  href="/my-house"
              ...
              <li className={`rounded-sm hover:bg-black hover:text-white ${"Deposit"===active&&'bg-black text-white'}`} onClick={()=>handleNavigate("Deposit")}>
                <Link
                  href="/my-house/deposit"
                  className="flex items-center p-2 space-x-3 rounded-md"
                >
                <TbMoneybag size={24}/>
                  <span>Deposit</span>
