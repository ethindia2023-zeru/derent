...
export enum eContractid {
  ...
  ZToken = "ZToken",
  MockZToken = "MockZToken",
  DelegationAwareZToken = "DelegationAwareZToken",
  ...
  ZTokensAndRatesHelper = "ZTokensAndRatesHelper",
  ...
  ZScore = "ZScore",
  ZScoreImpl = "ZScoreImpl",
  EligibilityDataProvider = "EligibilityDataProvider",
  EligibilityDataProviderImpl = "EligibilityDataProviderImpl",
  RewardsManager = "RewardsManager",
  RewardsManagerImpl = "RewardsManagerImpl",
  MasterChefZeru = "MasterChefZeru",
  MasterChefZeruImpl = "MasterChefZeruImpl",
  ZeruV1 = "ZeruV1",
  LendingPoolActionsImpl = "LendingPoolActionsImpl",
  LendingPoolActions = "LendingPoolActions",
  RankersRewardManager = "RankersRewardManager",
  RankersRewardManagerImpl = "RankersRewardManagerImpl",
  Leverager = "Leverager",
  LeveragerImpl = "LeveragerImpl",
  // Strategies
  BalancerV2Adapter = "BalancerV2Adapter",
  UniswapV3Adapter = "UniswapV3Adapter",
  UniversalZeruAdapter = "UniversalZeruAdapter",
  StrategiesConfiguration = "StrategiesConfiguration",
  StrategiesAddressesProvider = "StrategiesAddressesProvider",
  StrategiesController = "StrategiesController",
  MAXI = "Maxi",
  LP = "LP",
  Permissions = "Permissions",
  MaxiLiquidation = "MaxiLiquidation",
  LpLiquidation = "LpLiquidation",
...
export enum ProtocolErrors {
  ...
  LPC_INVALID_ZTOKEN_POOL_ADDRESS = "35", // 'The liquidity of the reserve needs to be 0'
  ...
  LP_CALLER_MUST_BE_AN_ZTOKEN = "63",
...
>;
export type iBinancePoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "DAI" | "USDC" | "USDT" | "WBTC" | "WETH" | "WMATIC" | "AAVE"
>;

export type iArbitrumPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "DAI" | "USDC" | "USDT" | "WBTC" | "WETH" | "LINK" | "ARB"
>;
...
export interface IReserveParams extends IReserveBorrowParams, IReserveCollateralParams {
  zTokenImpl: eContractid;
  reserveFactor: string;
  creditFactor: string;
  strategy: IInterestRateStrategyParams;
  assetIndex: BigNumberish;
  reserveBorrowCap: BigNumberish;
}
...
export interface iBinanceParamsPerNetwork<T> {
  [eBinanceNetwork.testbsc]: T;
}
...
export interface iArbitrumParamsPerNetwork<T> {
  [eArbitrumNetwork.goerli]: T;
  [eArbitrumNetwork.mainnet]: T;
}
...
export interface IBaseConfiguration {
  ...
  ZTokenDomainSeparator: iParamsPerNetwork<string>;
